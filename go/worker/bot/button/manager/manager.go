...
func (m *ComponentInteractionManager) RegisterCommands() {
	m.buttonRegistry = append(m.buttonRegistry,
		...
		new(handlers.GDPRAllTranscriptsHandler),
		new(handlers.GDPRSpecificTranscriptsHandler),
		new(handlers.GDPRAllMessagesHandler),
		new(handlers.GDPRSpecificMessagesHandler),
		new(handlers.GDPRConfirmAllTranscriptsHandler),
		new(handlers.GDPRConfirmSpecificTranscriptsHandler),
