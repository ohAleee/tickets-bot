export const FRONTPAGE_URL = env.FRONTPAGE_URL || "https://tickets.bot";
export const DOCS_URL = env.DOCS_URL || "https://docs.tickets.bot";
export const API_URL = env.API_URL || "http://localhost:8081";
export const WS_URL = env.WS_URL || "ws://localhost:8081";
export const INVITE_URL = env.INVITE_URL || "https://invite.tickets.bot";
export const TITLE = env.TITLE || "Tickets V2 | A Discord Support Manager Bot";
